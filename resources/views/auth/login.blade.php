    ...
    <div class="row justify-content-center auth-body">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="get" action="{{url('user/login')}}" aria-label="{{ __('Login') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="userID" class="form-control{{ $errors->has('userID') ? ' is-invalid' : '' }}" name="userID" value="{{ old('userID') }}" required autofocus>
